...
read_verilog  HK2_1516.vo
current_design HK2_1516
link
...
set_load -pin_load 10 [get_ports { G1 } ]
set_load -pin_load 10 [get_ports { G2 } ]
set_load -pin_load 10 [get_ports { R1 } ]
set_load -pin_load 10 [get_ports { R2 } ]
set_load -pin_load 10 [get_ports { Y1 } ]
set_load -pin_load 10 [get_ports { Y2 } ]
